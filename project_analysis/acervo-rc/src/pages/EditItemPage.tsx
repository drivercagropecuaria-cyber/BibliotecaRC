...
export function EditItemPage() {
  ...
  return (
    <div className="max-w-4xl">
      <button onClick={() => navigate(-1)} className="flex items-center gap-2 text-neutral-600 hover:text-neutral-900 mb-6">
        <ArrowLeft className="w-5 h-5" />
        Voltar
      </button>

      <h1 className="text-3xl font-bold text-neutral-900 mb-2">Editar Item</h1>
      <p className="text-neutral-500 mb-6">Atualize os metadados do material</p>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Data de Captação</label>
            <input
              type="date"
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Área / Fazenda</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Ponto</label>
            <select
              value={form.ponto_id}
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Tipo de Projeto</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Tema Principal</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Núcleo Pecuária</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Núcleo Agro</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Evento</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Capítulo</label>
            <select
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-700 mb-2">Função Histórica</label>
            <select
        ...
        <div className="mt-8 flex justify-end gap-4">
          <button
            type="button"
            onClick={() => navigate(-1)}
            className="px-6 py-3 border border-neutral-200 rounded-lg text-neutral-700 hover:bg-neutral-50"
          >
            Cancelar
          </button>
          <button
